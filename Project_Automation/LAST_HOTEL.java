...
//	Thread.sleep(5000L);
	System.out.println(""+city+"\n"+checkin+"\n"+inmonth+"\n"+checkout+"\n"+outmonth);
	 ...
	 {
	 List<WebElement> dropdown =driver.findElements(By.xpath("//*[@class=\"autosuggest-category-result\"]"));
	 while(f==1)
	 {
     ...
     //Clicking Date Box
	 try {
	 driver.findElement(By.xpath("//*[@id=\"qf-0q-localised-check-in\"]")).click();}catch(Exception e)
	 {
...
try {
//Selecting Rooms	  
 Select s1=new Select(driver.findElement(By.xpath("//*[@id=\"qf-0q-rooms\"]")));
 s1.selectByVisibleText("1");
 
//Selecting Adults
 Select s2=new Select(driver.findElement(By.xpath("//*[@id=\"qf-0q-room-0-adults\"]")));
 s2.selectByVisibleText("2");
 
 //Selecting Children
 Select s3=new Select(driver.findElement(By.xpath("//*[@id=\"qf-0q-room-0-children\"]")));
...
try {
//Choosing Room
	List<WebElement> choose =driver.findElements(By.xpath("//*[@id=\"listings\"]/ol/li/article/section/aside/a"));
	cho=choose.get(0);
	 cho.click();
	 
	 List<WebElement> chooose =driver.findElements(By.xpath("//*[@class=\"description resp-module\"]/h3/a"));
		cho=chooose.get(1);
		 cho.click();
