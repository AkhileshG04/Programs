...
List<WebElement> dates =  driver.findElements(By.xpath(".//*[@class='dateInnerCell']/p"));
 ...
 @Test
  public void d() throws InterruptedException
  {
	    ...
	    if(driver.findElement(By.xpath("//*[@class='block radio']//*[@value='no']")) != null)
	    		{
	     WebElement rb=driver.findElement(By.xpath("//*[@class='block radio']//*[@value='no']"));//radio_button
	     Thread.sleep(2000L);
	     rb.click();
	    		}
 ...
 public void e() throws InterruptedException
 {
	     ...
	     email.click();
	     Thread.sleep(2000L);
	     email.sendKeys("examplemail@gmail.com");//Email
