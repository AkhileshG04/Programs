...
driver.manage().window().maximize();
  ...
  public void b() throws InterruptedException, IOException
  {
	  ...
	  if((driver.findElements(By.xpath("//*[@class=\"pull-left make_relative\"]//*[@class=\"mltfr-arrow arrow-down-icon-white\"]")))!=null)
	  {
	driver.findElements(By.xpath("//*[@class=\"pull-left make_relative\"]//*[@class=\"mltfr-arrow arrow-down-icon-white\"]")).get(1).click();
	driver.findElements(By.xpath("//*[@class=\"faresRightSection\"]/button")).get(0).click();	  
	  }
